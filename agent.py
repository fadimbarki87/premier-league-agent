...
def formulate_answer(question: str, result: str) -> str:
    ...
    system_prompt = (
        ...
        "If result is 'No results.', respond with: "
        "Your question is not deterministic, I do not answer follow‑ups to avoid confusion. "
        "I only answer questions related to the players in the database. "
        "Please write a deterministic question that can be answered from the database columns and rows.\n"
